...
// const emailValidation = aj.withRule({mode: 'LIVE', block: ['DISPOSABLE', 'INVALID', 'NO_MX_RECORDS']})
...
//             throw new Error('Rate Limit Eceeded')
//         }

//         if (decision.reason.isShield()) {
//             throw new Error('Shield turned on protected from malicious actions')
//         }
//     }
